...
ontology_annot_count_df = pd.DataFrame(list(matches_tools_ontology.items()), columns= ['tool','ontology annotations count']).sort_values('ontology annotations count', ascending=False)
...
df_ranked_tools.to_csv('outputs/ontology/ranked_tools.csv', index=False)
