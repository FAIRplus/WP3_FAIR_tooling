...
class tools_discoverer(object):
    ...
    def prepare_html_table(self):
        ...
        self.html_df['Operations'] = self.html_df['Operations'].apply(self.prep_lists, label='operation')
    ...
    def save_md(self):
        ...
        self.md_df['Operations'] = self.md_df['Operations'].apply(self.prep_md_lists_fancy)
